...
* URL：`https://openapi.digifinex.com/v3/currency_ticker?currencys=BTC,ETH,TRX`
* 请求方法: GET
* 请求参数: 
* 请求说明：价格以CNY计价
...
|参数名			|参数类型		|必填		|描述|
| :-----   	| :-----   	| :-----  | :-----   |
|currencys		|string		|0			|币种列表，逗号分隔，不传参数则表示所有币种列表|
...
```
# Request
GET https://openapi.digifinex.com/v3/currency_ticker?currencys=BTC,ETH,TRX
...
# Response
{
  ...
  "list": {
    "BTC": {
      "price_change_rate_24h": "5400.00%",
      "min_price": 37455,
      "new_price": 37455,
      "max_price": 37455
    },
    "ETH": {
      "price_change_rate_24h": "0.00%",
      "min_price": 783.0819,
      "new_price": 783.0819,
      "max_price": 783.0819
    },
...
date: 服务器数据返回的当前时间戳
list: 币种行情列表
	price_change_rate_24h: 24小时价格变动
	min_price: 24H最低价
	new_price: 当前价格
	max_price: 24H最高价
```
...
* URL：`https://openapi.digifinex.com/v3/currency_kline?currency=BTC&type=1&from=1559354460&to=1559365260`
* 请求方法: GET
* 请求参数: 
* 请求说明：价格以CNY计价
...
|参数名			|参数类型		|必填		|描述|
| :-----   	| :-----   	| :-----  | :-----   |
|currency		|string		|1			|币种|
|type		|int		|1			|K线类型，1,5,15,30,60,240,720,1D,1W|
|from		|int		|1			|开始时间|
|to		|int		|1			|结束时间|
...
```
# Request
GET https://openapi.digifinex.com/v3/currency_kline?currency=BTC&type=1&from=1559354460&to=1559365260

# Response
{
  "code":0,
  "data":[
    [1559354760,0,37455,37455,37455,37455],
	[1559354820,0,37455,37455,37455,37455],
	[1559354940,0,37455,37455,37455,37455],
	[1559355360,0,37455,37455,37455,37455],
	[1559355660,0,37455,37455,37455,37455],
	[1559355720,0,37455,37455,37455,37455],
	[1559355840,0,37455,37455,37455,37455],
	[1559357940,0,37455,37455,37455,37455],
	[1559362140,0,37455,37455,37455,37455],
	[1559363220,0,37455,37455,37455,37455]
  ]
}
```
